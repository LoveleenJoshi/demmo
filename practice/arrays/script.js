...
// const interest=movements.map(function(value){
//   return value*1.2;
// })
...
const total=movements.filter(cur=>cur<0).map((uSD,i,arr)=>{console.log(arr)
  return uSD*1.1}).reduceRight((acc,cur)=>acc+cur);
console.log(total)
